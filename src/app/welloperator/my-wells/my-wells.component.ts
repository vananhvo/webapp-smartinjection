...
export class MyWellsComponent implements AfterViewInit {
  ...
  displayedColumns: string[] = ['Well Name', 'Proposal Status', 'Lease', 'API Number', 'UIC Project Number', 'Location'];
  dataSource = new MatTableDataSource(WELL_DATA);
  columnsToDisplay = ['wellName', 'proposalStatus', 'lease', 'api', 'uicProjectNo', 'location'];
  expandedElement: myWells | null;
...
//   weight: number;
//   symbol: string;
//   description: string; //added in for expandable elements
// }
